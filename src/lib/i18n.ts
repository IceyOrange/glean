...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    // AI mindset prompt
    aiMindsetRole: "你是一个思维模式分析助手。用户积累了若干网页阅读时捕获的灵感片段。请分析这些记录，提炼用户的总体思维模式。",
    aiMindsetOutputLang: "请用中文回答，输出 JSON 格式：",
    aiMindsetThemesDesc: "核心主题，3-5 个",
    aiMindsetPatternsDesc: "思维偏好或模式，3-5 个",
  ...
  en: {
    ...
    // AI mindset prompt
    aiMindsetRole: "You are a mindset analysis assistant. The user has accumulated inspiration snippets captured while reading web pages. Analyze these records and distill their overall thinking patterns.",
    aiMindsetOutputLang: "Respond in English. Output JSON format:",
    aiMindsetThemesDesc: "core themes, 3-5 items",
    aiMindsetPatternsDesc: "thinking patterns or preferences, 3-5 items",
  ...
  fr: {
    ...
    // AI mindset prompt
    aiMindsetRole: "Vous êtes un assistant d'analyse de la pensée. L'utilisateur a accumulé des extraits d'inspiration capturés lors de la lecture de pages web. Analysez ces enregistrements et distillez ses schémas de pensée globaux.",
    aiMindsetOutputLang: "Répondez en français. Format JSON :",
    aiMindsetThemesDesc: "thèmes clés, 3 à 5 éléments",
    aiMindsetPatternsDesc: "préférences ou schémas de pensée, 3 à 5 éléments",
